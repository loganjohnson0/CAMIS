...
load('../data/cached_mmrm_results.rda')
```
...
cached_mmrm_results$conv_time_fev |>
  ...
  knitr::kable(
    caption = "Comparison of convergence times: milliseconds",
    digits = 2
  )
```
...
cached_mmrm_results$conv_time_bcva |>
  ...
  knitr::kable(
    caption = "Comparison of convergence times: seconds",
    digits = 2
  )
```
...
```{r}
#| label: review-missingness-table
#| warning: false
#| message: false
#| echo: false
## construct the table
...
```{r}
#| label: review-convergence-rate-missingness
#| message: false
#| warning: false
#| echo: false
