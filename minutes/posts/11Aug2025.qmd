...
-   Christina's guidance for how to select an appropriate R package to use for your work is now available [here](https://psiaims.github.io/CAMIS/contribution/Package-Review.html). You can also access it from [contribution](Get Involved) page, under the 'Asking for help' section using the short guidance link.
